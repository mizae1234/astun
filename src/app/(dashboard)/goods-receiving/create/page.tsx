      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select value={selectedCompany} onChange={(e) => { setSelectedCompany(e.target.value); setSelectedPO(""); setItems([]); }} className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm bg-white focus:ring-2 focus:ring-blue-500 outline-none">
